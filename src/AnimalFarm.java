...
String animaal = JOptionPane.showInputDialog("What animal do you want? Choose from Dog, duck, cow, or a Llama.");
	
if(animaal.equals("Dog")){
	playWoof();

}
else if(animaal.equals("Duck")){
	playQuack();
}
if (animaal.equals("Llama")){
	playLlama();
}
else{
	playMoo();
