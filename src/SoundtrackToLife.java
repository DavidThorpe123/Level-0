...
public class SoundtrackToLife {
	...
	public static void main(String[] args) {
		...
		if (userMood == 0) {
			playVideo("https://www.youtube.com/watch?v=UKwSQSFN4Nw");
		}
		// 4. Play different songs for other moods.
		if (userMood == 1) {
			playVideo("https://www.youtube.com/watch?v=4N3N1MlvVc4");
		}
		if (userMood == 2) {
			playVideo("https://www.youtube.com/watch?v=uBUvuKg6wuo");
		}
